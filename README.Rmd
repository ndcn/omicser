...
The goal is to make a shiny app which contains a simple omics data browser. A variety of data formats can be configured to browse.  See the  `Ingest` section below.
1install_miniconda(path = miniconda_path(), update = TRUE, force = FALSE)
**This a work in progress!!**

# Installation

This shiny app is build inside an R package and can be installed with `devtools::install_github("ergonyc/omicser")`.
...
```{r example}
list.of.packages <- c("devtools", "golem", "data.table", "DT", "magrittr")
